...
AZR-000503 | [Azure.Cosmos.MongoDBvCoreAvailabilityZone](Azure.Cosmos.MongoDBvCoreAvailabilityZone.md) | Azure Cosmos DB for MongoDB vCore clusters should use zone-redundant high availability. | GA
