...
Name | Synopsis | Severity
---- | -------- | --------
[Azure.Redis.AvailabilityZone](Azure.Redis.AvailabilityZone.md) | Premium and Enterprise Redis cache should be deployed with availability zones for high availability. | Important
