...
The following rules are included within the `Azure.GA_2022_12` baseline.

This baseline includes a total of 326 rules.



[:material-download: Download CSV](Azure.GA_2022_12.csv){ .md-button }
