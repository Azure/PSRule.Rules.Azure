...
Include rules released September 2024 or prior for Azure GA features.

## Rules

The following rules are included within the `Azure.GA_2024_09` baseline.

This baseline includes a total of 428 rules.



[:material-download: Download CSV](Azure.GA_2024_09.csv){ .md-button }
