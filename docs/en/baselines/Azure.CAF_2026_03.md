...
Includes rules related to Azure CAF based on a March 2026 snapshot.

## Rules

The following rules are included within the `Azure.CAF_2026_03` baseline.

This baseline includes a total of 98 rules.
