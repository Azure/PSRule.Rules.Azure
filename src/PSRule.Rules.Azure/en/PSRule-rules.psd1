...
@{
    ...
    ACRExportPolicyDisabled = "The container registry '{0}' should have export policy disabled to prevent data exfiltration."
    ACRPublicNetworkAccessDisabled = "The container registry '{0}' should have public network access disabled when export policy is disabled."
