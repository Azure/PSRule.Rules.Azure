...
@{
    ...
    MICassandraAvailabilityZone = "The Managed Instance for Apache Cassandra data center ({0}) deployed to region ({1}) should use availability zones from the following [{2}]."
