...
@{
    ...
    VMSecureBoot = "The virtual machine '{0}' should use Trusted Launch or Confidential VM security type."
    VMSecureBootEnabled = "The virtual machine '{0}' should have Secure Boot enabled."
    VMSSSecureBoot = "The virtual machine scale set '{0}' should use Trusted Launch or Confidential VM security type."
