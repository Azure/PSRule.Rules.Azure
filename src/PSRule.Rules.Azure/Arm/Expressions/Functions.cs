...
/// <summary>
/// Implementation of Azure Resource Manager (ARM) functions as ExpressionFn.
/// This class contains an implementation of the functions available in ARM templates.
/// Each function must be implemented otherwise expansion will fail.
/// </summary>
internal static class Functions
{
    ...
    private const string PROPERTY_PROVIDER_NAMESPACE = "providerNamespace";
    private const string PROPERTY_LOCATION = "location";
    private const string PROPERTY_NUMBER_OF_ZONES = "numberOfZones";
    ...
    {
        return CountArgs(args) > 0 ? throw ArgumentsOutOfRange(nameof(Null), args) : null;
    }
