...
Rule 'Azure.Automation.RunbookPinned' -Ref 'AZR-000535' -Type 'Microsoft.Automation/automationAccounts/runbooks' -Tag @{ release = 'GA'; ruleSet = '2026_06'; 'Azure.WAF/pillar' = 'Security'; } {
