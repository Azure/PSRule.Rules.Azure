...
# Synopsis: Use zone redundant Grafana instances in supported regions to improve reliability.
Rule 'Azure.Grafana.AvailabilityZone' -Ref 'AZR-000500' -Type 'Microsoft.Dashboard/grafana' -Tag @{ release = 'GA'; ruleSet = '2025_12'; 'Azure.WAF/pillar' = 'Reliability'; } {
    # Check for availability zones based on Compute, because it is not exposed through the provider for Grafana.
