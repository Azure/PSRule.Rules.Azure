...
Rule 'Azure.Firewall.AvailabilityZones' -Ref 'AZR-000429' -Type 'Microsoft.Network/azureFirewalls' -Tag @{ release = 'GA'; ruleSet = '2024_06 '; 'Azure.WAF/pillar' = 'Reliability'; } {
