...
Rule 'Azure.ServiceFabric.AAD' -Ref 'AZR-000179' -Type 'Microsoft.ServiceFabric/clusters' -Tag @{ release = 'GA'; ruleSet = '2021_03'; 'Azure.WAF/pillar' = 'Security'; } -Labels @{ 'Azure.MCSB.v1/control' = @('IM-1', 'IM-3') } {
