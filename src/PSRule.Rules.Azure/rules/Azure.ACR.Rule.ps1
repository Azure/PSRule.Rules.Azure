...
Rule 'Azure.ACR.GeoReplica' -Ref 'AZR-000004' -Type 'Microsoft.ContainerRegistry/registries' -Tag @{ release = 'deprecated'; ruleSet = '2025_09'; 'Azure.WAF/pillar' = 'Reliability'; } {
