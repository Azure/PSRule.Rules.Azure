...
namespace PSRule.Rules.Azure.Data
{
    ...
    /// </summary>
    internal sealed class ProviderData : ResourceLoader
    {
        ...
        private readonly Dictionary<string, ResourceProviderType[]> _ProviderCache;
        private TypeIndex _Index;

        public ProviderData(bool useCache = true)
            : base()
        {
            _ProviderCache = useCache ? new Dictionary<string, ResourceProviderType[]>() : null;
        }
