...
task PSRule NuGet, {
    if ($Null -eq (Get-InstalledModule -Name PSRule -RequiredVersion 0.13.0 -ErrorAction Ignore)) {
        Install-Module -Name PSRule -Repository PSGallery -RequiredVersion 0.13.0 -Scope CurrentUser -Force;
    }
