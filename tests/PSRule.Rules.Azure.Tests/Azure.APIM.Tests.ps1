...
Describe 'Azure.APIM' -Tag 'APIM' {
    Context 'Conditions' {
        ...
        It 'Azure.APIM.MultiRegion' {
            ...
            $ruleResult[0].Reason | Should -BeExactly "The API management instance 'apim-D' should use multi-region deployment model.";
            $ruleResult[1].Reason | Should -BeExactly "The API management instance 'apim-E' should use multi-region deployment model.";
            $ruleResult[2].Reason | Should -BeExactly "The API management instance 'apim-H' should use multi-region deployment model.";
