...
Describe 'Azure.ML' -Tag 'ML' {
    Context 'Conditions' {
        BeforeAll {
            ...
            $dataPath = Join-Path -Path $here -ChildPath 'Resources.ML.json';
            $result = Invoke-PSRule @invokeParams -InputPath $dataPath;
        }

        It 'Azure.ML.ComputeIdleShutdown' {
            $filteredResult = $result | Where-Object { $_.RuleName -eq 'Azure.ML.ComputeIdleShutdown' };
        ...
        It 'Azure.ML.DisableLocalAuth' {
            $filteredResult = $result | Where-Object { $_.RuleName -eq 'Azure.ML.DisableLocalAuth' };
